...
public class NotificationHelper extends ContextWrapper {
    ...
    public void sendHighPriorityNotification(String title, String body, Class activityName) {
        ...
        // index of geofence for multiple geofences
//        contentIntent.putExtra(GeofencingConstants.EXTRA_GEOFENCE_INDEX, foundIndex);
        PendingIntent pendingIntent;

        // initiate pending intent
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.S) {
            pendingIntent = PendingIntent.getActivity(this, 267, intent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
        } else {
